...
mappa_sensori <- bind_rows(
  data.frame(
    ...
    y = c(    49, 98, 141, 162, 181, 181, 180, 191, 190, 208,
    220, 243, 251, 256, 272, 275, 288, 288, 297)
  ),
  data.frame(
    ...
    x = c(    588, 627, 272, 296, 365, 370, 474, 507, 673, 630,
    666, 374, 465, 271, 301, 201),
    y = c(    29, 29, 126, 127, 116, 194, 165, 213, 368, 402,
    410, 432, 431, 449, 448, 435)
  ),
  data.frame(
    ...
    x = c(    34, 142, 376, 435, 239, 284, 418, 528, 473, 472,
    472, 528, 435, 376, 410, 427, 397, 339, 379, 200,
    220, 274, 297, 339, 284, 256, 173, 151, 34, 73,
    113, 140, 693, 723),
    y = c(    74, 74, 84, 84, 137, 167, 138, 177, 175, 193,
    232, 255, 328, 328, 252, 277, 262, 168, 143, 201,
    221, 196, 216, 216, 255, 180, 251, 288, 260, 260,
    260, 252, 387, 416)
  ),
  data.frame(
    ...
    x = c(    285, 246, 395, 217, 217, 578, 578, 206, 581, 559,
    216, 163, 518, 485, 585),
    y = c(    91, 91, 167, 189, 210, 188, 206, 272, 272, 375,
    380, 413, 429, 478, 456)
  )
) |>
  mutate(
